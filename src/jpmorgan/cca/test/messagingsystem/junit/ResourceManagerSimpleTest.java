...
import jpmorgan.cca.test.messagingsystem.Resource;
...
import jpmorgan.cca.test.messagingsystem.impl.ResourceSimple;
...
public class ResourceManagerSimpleTest {
	...
	/**
	 * This array holds the minimum and maximum processing times for each
