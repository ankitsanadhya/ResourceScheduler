...
import jpmorgan.cca.test.messagingsystem.ResourceSchedulerAbstract;
...
public class ResourceSchedulerGroupPriority extends ResourceSchedulerAbstract {
	...
	/***
	 * This method decides if the input message (presumably on top of the queue) can be sent to the gateway. 
	...
	/**
	 * Utility method to check if the message queue contains a certain message group.
	...
	/**
	 * This method looks for the next suitable message to be sent to the gateway. This 
