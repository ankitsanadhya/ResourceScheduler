...
public abstract class ResourceManager {
	...
	/***
	 * This method receives a message, and tries to process it with any available resource at the time.
	...
	/***
	 * This method receives a message, and tries to process it with the given resource. The resource does not 
	...
	/***
	 * This method updates the hasAvailableResources boolean value. Assigns it to true if there is 
	...
	/***
	 * This method is called by the resource scheduler, in order to wait for resources to become 
	 * available
	 * @throws InterruptedException
	 */
	...
	/***
	 * This method returns the fastest available resource, by comparing the Resource.getProcessingSpeed()
